...
void AppendScoutFuncs(wabt::interp::Environment* env, wabt::interp::HostModule* host_module_env) {
  ...
  host_module_env->AppendFuncExport(
    ...
    [env](
      ...
      // prestate from daiquiri/tests/tests-withdraw.yml
      // 1a3912607947d9ce70ce8355d71f34a9d514184fbf34ac49792328c2f01a4525
      unsigned char prestateRoot[] = {0x1a, 0x39, 0x12, 0x60, 0x79, 0x47, 0xd9, 0xce, 0x70, 0xce, 0x83, 0x55, 0xd7, 0x1f, 0x34, 0xa9, 0xd5, 0x14, 0x18, 0x4f, 0xbf, 0x34, 0xac, 0x49, 0x79, 0x23, 0x28, 0xc2, 0xf0, 0x1a, 0x45, 0x25};
