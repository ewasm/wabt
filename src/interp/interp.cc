...
/***** For rollup.rs, the constants are passed in as arguments, so they aren't needed ****/
/***** For websnark, the constants are hard-coded, so they are needed. ****/
...
#undef ATOMIC_RMW
      ...
      /****  Bignum functions for rollup.rs *****/
